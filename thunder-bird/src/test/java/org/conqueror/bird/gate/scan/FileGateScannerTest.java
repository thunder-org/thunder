...
public class FileGateScannerTest {
    ...
    public void scan() throws SchemaException, ScanException {
        ...
        GateSource source = new FileGateSource("file:///G:/workspace/thunder/data/sources/estate_data.201601.json", new DocumentSchema[] {documentSchema}, JsonLineParser.getInstance());
        scanner.open(source);
